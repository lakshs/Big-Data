...
SELECT worksite,COUNT(case_status) AS number_of_petition,year from h1b_final WHERE job_title LIKE '%DATA ENGINEER%' and case_status = 'CERTIFIED' and year= '${hiveconf:year}' GROUP BY worksite,year ORDER BY number_of_petition desc limit 1;
